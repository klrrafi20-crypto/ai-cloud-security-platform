...
- The free-tier Gemini API allows a limited number of requests per day; heavy testing may temporarily exhaust this quota, if its a paid key no limitations.
